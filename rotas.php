...
SimpleRouter::get("cursos/admin/cadastrar","ControladorCategoria@cadastrarCategoria");
SimpleRouter::post("cursos/admin/cadastrar","ControladorCategoria@cadastrarCategoria");
SimpleRouter::get("cursos/admin/editar/{id}","ControladorCategoria@editarCategoria");
SimpleRouter::post("cursos/admin/editar/{id}","ControladorCategoria@editarCategoria");
SimpleRouter::get("cursos/admin/deletar/{id}","ControladorCategoria@deletarCategoria");
